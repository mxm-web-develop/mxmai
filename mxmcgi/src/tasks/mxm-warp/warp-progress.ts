...
const STEP_MESSAGE: Record<string, string> = {
  webSearch: '检索资讯中…',
  injectWritingVoice: '装载文风中…',
  expandSeekVariants: '展开文风方案中…',
  ...
  expandDeckSlides: '展开幻灯片骨架…',
  renderPptx: '编译 PPTX…',
  groupFanout: '派发子任务中…',
  dialogueLineTts: '并发生成多段口播…',
  resolveDialogueTimeline: '展开对话时间轴…',
  renderAudioTimeline: '按时间轴混音成片…',
