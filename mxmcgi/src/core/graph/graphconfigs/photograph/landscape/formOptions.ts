...
export const landscapeFormOptionsEn: FormOptionsConfig = {
  timeOfDay: landscapeFormOptionsZh.timeOfDay.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  weather: landscapeFormOptionsZh.weather.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  season: landscapeFormOptionsZh.season.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  composition: landscapeFormOptionsZh.composition.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
};
