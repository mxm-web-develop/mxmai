...
export const formOptionsEn: FormOptionsConfig = {
  style: formOptionsZh.style.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  tone: formOptionsZh.tone.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  environment: formOptionsZh.environment.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  makeup: formOptionsZh.makeup.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  pose: formOptionsZh.pose.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  lighting: formOptionsZh.lighting.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
};
...
export function getAllOptionValues(): {
  ...
  return {
    style: formOptionsZh.style.map(opt => opt.value),
    tone: formOptionsZh.tone.map(opt => opt.value),
    environment: formOptionsZh.environment.map(opt => opt.value),
    makeup: formOptionsZh.makeup.map(opt => opt.value),
    pose: formOptionsZh.pose.map(opt => opt.value),
    lighting: formOptionsZh.lighting.map(opt => opt.value),
  };
}
