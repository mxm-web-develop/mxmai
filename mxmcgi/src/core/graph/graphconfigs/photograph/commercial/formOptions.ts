...
export const commercialFormOptionsEn: FormOptionsConfig = {
  productType: commercialFormOptionsZh.productType.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  background: commercialFormOptionsZh.background.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
  props: commercialFormOptionsZh.props.map(opt => ({
    value: opt.value,
    label: opt.labelEn || opt.value,
  })),
};
