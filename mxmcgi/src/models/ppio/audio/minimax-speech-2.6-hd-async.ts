...
const modelKey = 'minimax-speech-2.6-hd-async';
const logicalProvider = 'ppio';

async function generateImpl(params: MinimaxSpeech26HdAsyncParams, _ctx?: ModelContext & { providerOverride?: ProviderType }): Promise<MinimaxSpeech26HdAsyncResult> {
...
const definition: ModelDefinition<MinimaxSpeech26HdAsyncParams, MinimaxSpeech26HdAsyncResult> = { provider: logicalProvider, scope: 'audio', modelKey, generate: generateImpl };
