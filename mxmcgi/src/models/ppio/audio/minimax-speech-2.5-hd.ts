...
const modelKey = 'minimax-speech-2.5-hd';
const logicalProvider = 'ppio';

async function generateImpl(params: MinimaxSpeech25HdParams, _ctx?: ModelContext & { providerOverride?: ProviderType }): Promise<MinimaxSpeech25HdResult> {
...
const definition: ModelDefinition<MinimaxSpeech25HdParams, MinimaxSpeech25HdResult> = { provider: logicalProvider, scope: 'audio', modelKey, generate: generateImpl };
