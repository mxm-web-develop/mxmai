...
const modelKey = 'minimax-speech-2.5-turbo-async';
const logicalProvider = 'ppio';

async function generateImpl(params: MinimaxSpeech25TurboAsyncParams, _ctx?: ModelContext & { providerOverride?: ProviderType }): Promise<MinimaxSpeech25TurboAsyncResult> {
...
const definition: ModelDefinition<MinimaxSpeech25TurboAsyncParams, MinimaxSpeech25TurboAsyncResult> = { provider: logicalProvider, scope: 'audio', modelKey, generate: generateImpl };
