...
const modelKey = 'minimax-speech-2.5-hd-async';
const logicalProvider = 'ppio';

async function generateImpl(params: MinimaxSpeech25HdAsyncParams, _ctx?: ModelContext & { providerOverride?: ProviderType }): Promise<MinimaxSpeech25HdAsyncResult> {
...
const definition: ModelDefinition<MinimaxSpeech25HdAsyncParams, MinimaxSpeech25HdAsyncResult> = { provider: logicalProvider, scope: 'audio', modelKey, generate: generateImpl };
