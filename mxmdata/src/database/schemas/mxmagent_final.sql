-- ============================================
-- Smartflow/Agent 表结构（历史文件名 mxmagent_*，实现位于 mxmcgi）
-- 用于管理对话和智能体相关数据
-- ============================================
...
-- ============================================
-- 存储用户与 AI 的对话历史
-- messages 字段使用 JSONB 存储完整的对话消息列表
...
--         }
--       ],
--       "gmtCreate": "2024-01-01T00:00:01Z"
--     }
--   }
-- ]

-- smartflows.workflow_schema JSONB 结构示例（可选）：
-- {
--   "nodes": [
--     {"id": "step1", "type": "llm", "name": "理解用户意图"},
--     {"id": "step2", "type": "process", "name": "处理数据"},
--     {"id": "step3", "type": "output", "name": "生成输出"}
--   ],
--   "edges": [
--     {"from": "step1", "to": "step2"},
--     {"from": "step2", "to": "step3"}
